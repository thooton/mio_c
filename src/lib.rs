...
use std::{
    ...
    net::{AddrParseError, Ipv4Addr, Ipv6Addr, Shutdown, SocketAddr, SocketAddrV4, SocketAddrV6},
};
...
#[no_mangle]
pub extern "C" fn mio_new(evt_bufsz: u32, err: *mut u32) -> Mio {
    ...
    if sock_addr.is_v4 != 0 {
        unsafe {
            return SocketAddr::V4(SocketAddrV4::new(
                Ipv4Addr::from(sock_addr.inner.v4.ip),
        ...
        unsafe {
            return SocketAddr::V6(SocketAddrV6::new(
                Ipv6Addr::from(sock_addr.inner.v6.ip),
...
#[no_mangle]
pub extern "C" fn mio_sock_addr_from(addr: *const u8, addr_len: u32, err: *mut u32) -> MioSockAddr {
    let addr_slice = unsafe { core::slice::from_raw_parts(addr, addr_len as usize) };
    let addr_str_maybe = unsafe { core::str::from_utf8(addr_slice) };
...
#[no_mangle]
pub extern "C" fn mio_tcp_server_new(sock_addr: MioSockAddr, err: *mut u32) -> MioTcpServer {
...
#[no_mangle]
pub extern "C" fn mio_tcp_server_register(
    mio: *mut Mio,
...
#[no_mangle]
pub extern "C" fn mio_tcp_server_reregister(
    mio: *mut Mio,
    server: *mut MioTcpServer,
    token: u32,
    interests: u32,
...
pub extern "C" fn mio_tcp_server_deregister(mio: *mut Mio, server: *mut MioTcpServer) -> u32 {
    let res = unsafe { (*mio).poll.registry().deregister(&mut ((*server).inner)) };
    if res.is_err() {
        return 1;
    }
    return 0;
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_new(socket_addr: MioSockAddr, err: *mut u32) -> MioTcpClient {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_register(
    mio: *mut Mio,
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_reregister(
    mio: *mut Mio,
    client: *mut MioTcpClient,
    token: u32,
    interests: u32,
...
pub extern "C" fn mio_tcp_client_deregister(mio: *mut Mio, client: *mut MioTcpClient) -> u32 {
    let res = unsafe { (*mio).poll.registry().deregister(&mut ((*client).inner)) };
    if res.is_err() {
        return 1;
    }
    return 0;
...
#[no_mangle]
pub extern "C" fn mio_tcp_server_accept(
    server: *const MioTcpServer,
    err: *mut u32,
) -> MioTcpClient {
...
#[no_mangle]
pub extern "C" fn mio_tcp_server_set_ttl(server: *const MioTcpServer, ttl: u32) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_server_ttl(server: *const MioTcpServer, err: *mut u32) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_shutdown_read(client: *const MioTcpClient) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_shutdown_write(client: *const MioTcpClient) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_shutdown_both(client: *const MioTcpClient) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_set_nodelay(client: *const MioTcpClient, nodelay: u32) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_get_nodelay(client: *const MioTcpClient, err: *mut u32) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_set_ttl(client: *const MioTcpClient, ttl: u32) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_ttl(client: *const MioTcpClient, err: *mut u32) -> u32 {
...
pub extern "C" fn mio_tcp_client_peek(
    ...
    let sl = unsafe { core::slice::from_raw_parts_mut(buf, buf_len as usize) };
    loop {
...
pub extern "C" fn mio_tcp_client_write(
    ...
    let client_ref = unsafe { &mut *client };
    let sl = unsafe { core::slice::from_raw_parts(buf, buf_len as usize) };
    loop {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_flush(client: *mut MioTcpClient) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_local_addr(
    client: *mut MioTcpClient,
    err: *mut u32,
) -> MioSockAddr {
...
#[no_mangle]
pub extern "C" fn mio_tcp_client_peer_addr(
    client: *mut MioTcpClient,
    err: *mut u32,
) -> MioSockAddr {
...
#[no_mangle]
pub extern "C" fn mio_tcp_server_local_addr(
    server: *mut MioTcpServer,
    err: *mut u32,
) -> MioSockAddr {
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_new(sock_addr: MioSockAddr, err: *mut u32) -> MioUdpSocket {
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_connect(
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_local_addr(
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_peer_addr(
    socket: *mut MioUdpSocket,
    err: *mut u32,
) -> MioSockAddr {
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_set_ttl(socket: *const MioUdpSocket, ttl: u32) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_ttl(socket: *const MioUdpSocket, err: *mut u32) -> u32 {
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_recv_from(
    socket: *const MioUdpSocket,
    dst: *mut u8,
    dst_len: u32,
    amt: *mut u32,
    ...
    let sl = unsafe { core::slice::from_raw_parts_mut(dst, dst_len as usize) };
    loop {
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_peek_from(
    socket: *const MioUdpSocket,
    dst: *mut u8,
    dst_len: u32,
    amt: *mut u32,
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_register(
    mio: *mut Mio,
    socket: *mut MioUdpSocket,
    token: u32,
    interests: u32,
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_reregister(
    mio: *mut Mio,
    socket: *mut MioUdpSocket,
    token: u32,
    interests: u32,
...
pub extern "C" fn mio_udp_socket_deregister(mio: *mut Mio, socket: *mut MioUdpSocket) -> u32 {
    let res = unsafe { (*mio).poll.registry().deregister(&mut ((*socket).inner)) };
    if res.is_err() {
        return 1;
    }
    return 0;
...
#[no_mangle]
pub extern "C" fn mio_udp_socket_send_to(
    socket: *const MioUdpSocket,
    src: *const u8,
    src_len: u32,
    target: MioSockAddr,
    ...
    let sl = unsafe { core::slice::from_raw_parts(src, src_len as usize) };
